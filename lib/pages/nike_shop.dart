...
import '../data.dart';
import '../model.dart';
import '../UiItems/my_bottom_navigation_bar.dart';
import 'product_page.dart';

class NikeShop extends StatelessWidget {
  const NikeShop({Key? key}) : super(key: key);
      ...
      body: SafeArea(
        child: Stack(
          children: [
            ...
            const MyBottomNavigationBar(true),
          ],
        ),
      ),
    );
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  productShoes.name,
                  style: TextStyle(color: const Color.fromRGBO(168, 168, 170, 1), fontSize: doubleWidth(4)),
                ),
